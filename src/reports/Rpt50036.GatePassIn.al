report 50036 "E3 Gate In Print"
{
    ...
    dataset
    {
        dataitem(GateEntryHeader; "E3 Posted Gate Entry Header")
        {
            ...
            begin
                ...
                OutwardHeader.Reset();
                OutwardHeader.SetRange("Document No.", GateEntryHeader."Posted Gate Entry Outward No.");
    ...
    var
        ...
        GateOutHeader: Record "E3 Posted Gate Entry Header";
        GateOutDate: Date;
        GateOutTime: Time;
        OutwardHeader: Record "E3 Posted Gate Entry Header";
