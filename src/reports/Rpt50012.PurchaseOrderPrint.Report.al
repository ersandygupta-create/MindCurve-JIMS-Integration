report 50012 "Purchase Order Print"
{
    ...
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            column(TermsAndCondition; txtTermsAndCondition)
            {
            }
            column(Print_Caption; "Print Caption") { }
            ...
            begin
                ...
                POOrderTerms.Reset();
                POOrderTerms.SetRange("Voucher Type", PurchaseHeader."Voucher Type");
                POOrderTerms.SetRange(Active, true);
                POOrderTerms.SetCurrentKey(Code);

                if POOrderTerms.FindSet() then
                    repeat
                        if DelChr(POOrderTerms."Terms and Condition", '=', ' ') <> '' then
                            TermsBuilder.AppendLine(POOrderTerms."Terms and Condition");
                    until POOrderTerms.Next() = 0;

                txtTermsAndCondition := TermsBuilder.ToText();
        ...
        dataitem(PurchaseLine; "Purchase Line")
        {
            ...
            column(Line_Remarks; "Line Remarks") { }
    ...
    var
        ...
        txtTermName: Text;
        POOrderTerms: Record "E3 PO Order Terms & Conditions";
        txtTermsAndCondition: Text;
        TermsBuilder: TextBuilder;
