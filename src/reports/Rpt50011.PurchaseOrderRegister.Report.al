report 50011 "Purchase Order Register"
{
    ...
    begin
        ...
        ExcelBuf.AddColumn('Required Date', false, '', true, false, true, '', ExcelBuf."Cell Type"::Text); //Required Date
        ...
        ExcelBuf.AddColumn('Indent No', false, '', true, false, true, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.AddColumn('Indent Date', false, '', true, false, true, '', ExcelBuf."Cell Type"::Text); //Indent No & Indent Date
    ...
    begin
        ...
        ExcelBuf.AddColumn(PurchaseHeader."Transaction Type", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text);//Transaction Type
        ExcelBuf.AddColumn("Purchase Line"."Expected Receipt Date", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text); //Required date
        ...
        ExcelBuf.AddColumn("Purchase Line"."Indent No.", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text); //indent no
                                                                                                                          // Indent Date
                                                                                                                          // Indent Date
        Clear(IndentHeader);
        if IndentHeader.Get("Purchase Line"."Indent No.") then
            ExcelBuf.AddColumn(IndentHeader."Request Date", false, '', false, false, false, '', ExcelBuf."Cell Type"::Date)
        else
        ...
        ExcelBuf.AddColumn("Purchase Line"."Item Make Name", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text); //Iyem Make name
        ExcelBuf.AddColumn("Purchase Line".Quantity, false, '', false, false, false, '', ExcelBuf."Cell Type"::Number);//company
        ExcelBuf.AddColumn("Purchase Line"."Unit of Measure Code", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text);//UOM
        ExcelBuf.AddColumn("Purchase Line"."Quantity Received", false, '', false, false, false, '', ExcelBuf."Cell Type"::Text);//company
        ExcelBuf.AddColumn(("Purchase Line".Quantity * "Purchase Line"."Direct Unit Cost") - "Purchase Line"."Line Discount Amount", false, '', false, false, false, '', ExcelBuf."Cell Type"::Number);
