        ...
        area(Processing)
        {
            action("Receive")
            {
                ...
                var
                    ...
                    TempPostedSelectedGRNWorksheet: Record "E3 GRN Work Sheet" temporary;
                    GRNToReceive: Record "E3 GRN Work Sheet";
                ...
                begin
                    ...
                    if SelectedGRNWorksheet.FindFirst() then;
                    //GRNWorksheet := SelectedGRNWorksheet;
                    GRNToReceive.Reset();
                ...
                begin
                    ...
                    if SelectedGRNLine.FindSet() then
                        repeat
                            ...
                            if SelectedGRNLine."Lot Assigned" = true then begin
                                SkippedCount += 1;
                                continue;
                            end;
                    ...
                    if SkippedCount > 0 then
                        Message(
                            '%1 GRN line(s) processed successfully.\%2 GRN line(s) skipped because Receipt Qty is 0 or Lot alreadt assigned.',
                            SelectedCount,
                            SkippedCount)
                    else
            ...
            repeat
                ...
                if PurchRcptHeader.FindLast() then begin
                    ...
                    if not GRNLine.FindFirst() then begin
                        ...
                        GRNLine."Gross Amount" := SelectedGRNWorksheet."Line Gross";
                        GRNLine."Discount Amount" := SelectedGRNWorksheet."Line Discount Amount";
                        GRNLine."Discount %" := SelectedGRNWorksheet."Line Discount Percentage";
                        GRNLine."Taxable Amount" := SelectedGRNWorksheet."Taxable Amount";
                        GRNLine."CGST %" := SelectedGRNWorksheet."CGST %";
                        GRNLine."CGST Amount" := SelectedGRNWorksheet."CGST Amount";
                        GRNLine."SGST %" := SelectedGRNWorksheet."SGST %";
                        GRNLine."SGST Amount" := SelectedGRNWorksheet."SGST Amount";
                        GRNLine."IGST %" := SelectedGRNWorksheet."IGST %";
                        GRNLine."IGST Amount" := SelectedGRNWorksheet."IGST Amount";
                        GRNLine."UGST %" := SelectedGRNWorksheet."UGST %";
                        GRNLine."UGST Amount" := SelectedGRNWorksheet."UGST Amount";
                        GRNLine."Final Discount %" := SelectedGRNWorksheet."Final Discount %";
                        GRNLine."Final Discount Amount" := SelectedGRNWorksheet."Final Discount Amount";
                        GRNLine."Net Amount" := SelectedGRNWorksheet."OH Amt Net";
                        GRNLine."Landed SKU Value" := SelectedGRNWorksheet."Landed SKU Value";
                        GRNLine."Landed SKU Rate" := SelectedGRNWorksheet."Landed SKU Rate";
                        GRNLine.Remark := SelectedGRNWorksheet.Remark;
                        GRNLine.MRP := SelectedGRNWorksheet.MRP;
                        GRNLine."SKU MRP" := SelectedGRNWorksheet."SKU MRP";
                        GRNLine."Sale Rate" := SelectedGRNWorksheet."Sale Rate";
                        GRNLine."SKU Sale Rate" := SelectedGRNWorksheet."SKU Sale Rate";
                        GRNLine."Staff Sale Rate" := SelectedGRNWorksheet."Staff Sale Rate";
                        GRNLine."SKU Staff Sale Rate" := SelectedGRNWorksheet."SKU Staff Sale Rate";
                        GRNLine.Barcode := SelectedGRNWorksheet."Supplier Batch No.";
                        GRNLine."Batch No." := SelectedGRNWorksheet."Supplier Batch No.";
                        GRNLine."Manufacturing Date" := SelectedGRNWorksheet."Manufacturing Date";
                        GRNLine."Expiry Date" := SelectedGRNWorksheet."Expiry Date";
                        GRNLine."Item Make Code" := SelectedGRNWorksheet."Item Make Code";
                        GRNLine."GST Type Code" := SelectedGRNWorksheet."GST Type Code";
                        GRNLine."Item GST Nature" := Format(SelectedGRNWorksheet."Item GST Nature");
                        GRNLine."HSN Code" := SelectedGRNWorksheet."HSN Code";
