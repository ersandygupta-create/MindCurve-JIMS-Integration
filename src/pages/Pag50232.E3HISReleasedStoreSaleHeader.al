page 50232 "HIS Released Sales Indent Card"
{
    PageType = Card;
    ApplicationArea = All;
    UsageCategory = Documents;
    SourceTable = "E3 Indent Header";
    Caption = 'Released Sales Indent Header Card';
    ...
    actions
    {
        ...
        //             Rec."Indent Status" := Rec."Indent Status"::Released;
        //             Rec.Modify(true);
