page 50202 "E3 Posted UnBilled Service"
{
    Caption = 'Posted UnBilled Service Revenue';
    PageType = List;
    SourceTable = "E3 UnBilled Service Revenue";
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTableView = sorting("Entry No.") order(descending) where(Created = filter(true));
